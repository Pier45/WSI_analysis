...
class MainWindow(QMainWindow):
    ...
    def load_dict(self):
        name_f = os.path.join('D:/Download', 'tr_js.txt')
...
# def load_dict():
#     name_f = os.path.join('D:/Download', 'test_js.txt')
#     with open(name_f, 'r') as f:
#         dictionary = json.load(f)
#
#     return dictionary
...
# with sns.axes_style("darkgrid"):
#     plt.subplot(3, 1, 1)
#     n, bins, patches = plt.hist(list_epi, 550, alpha=0.75)
#     plt.xlim(0, 1)
#     plt.title('Epistemic uncertenty')
#     plt.subplot(3, 1, 2)
#     n1, bins1, patches1 = plt.hist(list_ale, 150, alpha=0.75)
#     plt.xlim(0, 1)
#     plt.title('Aleatoric uncertenty')
#     plt.subplot(3, 1, 3)
#     n2, bins2, patches2 = plt.hist(list_tot, 500, alpha=0.75)
#     plt.xlim(0, 1)
